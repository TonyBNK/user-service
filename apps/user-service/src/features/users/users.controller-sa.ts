import { BasicAuthGuard } from '@app/auth-lib';
...
import { ApiPaginatorResponse } from 'apps/user-service/src/common/decorators';
import { UserExistsGuard } from '../../common/guards';
