...
import { User } from '@app/decorators-lib';
...
import { UploadFileDto } from 'apps/user-service/src/infrastructure/files/s3/dto';
import { ApiPaginatorResponse } from '../../common/decorators';
